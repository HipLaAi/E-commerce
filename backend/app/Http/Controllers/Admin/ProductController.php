...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($product && $request->hasfile('image'))
		{
            foreach ($request->file('image') as $key => $item) {
			    ...
			    $item->move('D:\Công Nghệ Web Và Ứng Dụng\frontend\public\images\product', $name);
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->has('imageRemove')){
            foreach($request->input('imageRemove') as $item ){
                ...
                $imagePath = 'D:\Công Nghệ Web Và Ứng Dụng\frontend\public\images\product\\' . $image->image;
    ...
    public function destroy($id)
    {
        ...
        foreach($product->images as $item ){
            $imagePath = 'D:\Công Nghệ Web Và Ứng Dụng\frontend\public\images\product\\' . $item->image;

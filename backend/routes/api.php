...
Route::prefix('')->middleware(['auth:sanctum', 'ability:user'])->group(function () {
    ...
    Route::post('updateOrder', [\App\Http\Controllers\User\SalleBillController::class, 'updateOrder']);
});
...
Route::prefix('admin')->middleware(['auth:sanctum', 'ability:admin'])->group(function () {
    ...
    Route::post('print', [\App\Http\Controllers\Admin\SalleBillController::class, 'printSalleBill']);
});
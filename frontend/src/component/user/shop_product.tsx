...
const ShopProduct: React.FC<Props> = ({relatedProduct}) => {
    ...
    const fetchData = async () => {
        ...
        // console.log(relatedProduct.length)
        setLoading(false)
    }
                        ...
                        >
                            ...
                            <div className='p-4 grid gap-1'>
                                ...
                                <button
                                    ...
                                    className='bg-orange-500 hover:bg-orange-600 text-white px-3 rounded-full py-0.5 text-sm'
                                >
                                    Add to Cart
                                </button>
                            </div>
            ...
            <div className='flex justify-between items-center mt-10'>
                <nav aria-label="Page navigation example">
                    <ul className="inline-flex -space-x-px text-base h-10">
                        {
                            (paginate?.[0]?.['url'] === null || paginate[0] == null) ? (
                                <li>
                                    <Link
                                        to={'/shop'}
                        ...
                        {
                            (paginate?.[paginate.length - 1]?.['url'] === null || paginate[0] == null) ? (
                                <li>
                                    <Link
                                        to={'/shop'}

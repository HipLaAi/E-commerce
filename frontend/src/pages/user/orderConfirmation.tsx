...
import { apiGetData, apiUpdate } from '../../services/user/order.services';
...
const OrderConfirmation = () => {
    ...
    const handleCancel = async () => {
        await apiUpdate({ data: order?.[0]?.id, action: 'cancel' });
        fetchData();
    }
    ...
    return (
        <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
            <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                ...
                {
                    (order?.[0]?.status == 1) ? (
                        <h2 className="text-xl font-semibold text-green-500 dark:text-white sm:text-2xl">
                            Order Success
                        </h2>
                    ) : (
                        <h2 className="text-xl font-semibold text-red-500 dark:text-white sm:text-2xl">
                            Bill Canceled
                        </h2>
                    )
                }
                                ...
                                <div key={index} className="space-y-4 p-6">
                                    ...
                                    <div className="flex items-center justify-between gap-4">
                                        ...
                                        <div className="flex items-center justify-end gap-4">
                                            ...
                                            <p className=" text-base font-medium leading-tight text-gray-900 dark:text-white">
                                                ${item.total}
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div className="space-y-4 bg-gray-50 p-6 dark:bg-gray-800">
                            <div className="space-y-2">
                                <dl className="flex items-center justify-between gap-4">
                                    <dt className="font-bold text-gray-900 dark:text-gray-400">
                                        Total
                                    </dt>
                    ...
                    <div className="mt-6 grow sm:mt-8 lg:mt-0">
                        <div className="space-y-6 rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <div className="gap-4 sm:flex sm:items-center">
                                ...
                                {
                                    (order?.[0]?.status == 1) ? (
                                        <Button onClick={handleCancel} danger type='primary' className="w-full rounded-lg p-5 font-medium flex items-center justify-center">
                                            Cancel
                                        </Button>
                                    ) : (
                                        <></>

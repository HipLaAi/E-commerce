...
const Product: React.FC = () => {
    ...
    const columns: ColumnsType<ProductType> = [
        ...
        //     width: "150px",
        //     render: (_, record) => {
        //         const totalQuantity = record.product_detail.reduce((sum, item) => sum + item.quantity, 0);
        //         return totalQuantity < 30 ? <div style={{ backgroundColor: '#bfefc4', color: '#02790c', width: '100px', padding: '5px', textAlign: 'center', borderRadius: '5px' }}>Still in stock</div> : 
        //         <div style={{ backgroundColor: '#f9c9cd', color: '#a90312', width: '100px', padding: '5px', textAlign: 'center', borderRadius: '5px' }}>Out of stock</div>;
        //     },
        // },

        {
            ...
            width: "150px",
            render: (_, record) => {
                const minQuantity = record.product_detail.reduce((min: any, item: any) => { return item.quantity < min ? item.quantity : min },Infinity );
                return minQuantity > 30 ? <div style={{ backgroundColor: '#bfefc4', color: '#02790c', width: '100px', padding: '5px', textAlign: 'center', borderRadius: '5px' }}>Still in stock</div> : 
                <div style={{ backgroundColor: '#f9c9cd', color: '#a90312', width: '100px', padding: '5px', textAlign: 'center', borderRadius: '5px' }}>Out of stock</div>;
            },
        },

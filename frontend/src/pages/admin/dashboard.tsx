...
import DropWater from "../../component/admin/dashboard/dropwater";
import LineChart from "../../component/admin/dashboard/linechart";
import Progresses from "../../component/admin/dashboard/progress";
import Statistics from "../../component/admin/dashboard/statistic";
import Water from "../../component/admin/dashboard/water";

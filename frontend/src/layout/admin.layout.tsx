...
const AdminLayout: React.FC = () => {
  ...
  const items: MenuItem[] = [
    ...
    getItem('General', 'sub1', <DatabaseOutlined />, [
      getItem(<Link to={ROUTER.ADMIN.CATEGORY}>Category</Link>, '2'),
      // getItem(<Link to={ROUTER.ADMIN.BRAND}>Brand</Link>, '3',undefined, undefined, 'ant-menu-item-selected'),
      getItem(<Link to={ROUTER.ADMIN.BRAND}>Brand</Link>, '3'),
      getItem(<Link to={ROUTER.ADMIN.PRODUCT}>Product</Link>, '4'),
    ]),
    
    getItem('System', 'sub2', <DesktopOutlined />, [
    ...
    getItem('Bill', 'sub3', <FileDoneOutlined />, [
      getItem(<Link to={ROUTER.ADMIN.SALLEBILL}>Salle</Link>, '7'),
